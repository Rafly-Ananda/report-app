...
document.querySelector("#validate__btn").addEventListener("click", () => {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/upload/validate", {
      month: data,
    })
    .then(() => {
      alert("Validated");
