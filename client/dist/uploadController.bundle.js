...
/***/ "./client/src/js/tools/generateUploadInput.js":
/*!****************************************************!*\
  !*** ./client/src/js/tools/generateUploadInput.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _tools_dynamicInputField__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tools/dynamicInputField */ "./client/src/js/tools/dynamicInputField.js");
/* harmony import */ var _tools_generateUploadInput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tools/generateUploadInput */ "./client/src/js/tools/generateUploadInput.js");
  ...
  textFieldParent.forEach((field) => {
    field.addEventListener("click", (e) => {
      ...
      if (e.target.classList.contains("add__field")) {
        ...
        !tableSelector
          ? (0,_tools_dynamicInputField__WEBPACK_IMPORTED_MODULE_1__.addFields)(parentSelector)
          : (0,_tools_dynamicInputField__WEBPACK_IMPORTED_MODULE_1__.addFields)(parentSelector, tableSelector);
        tableSelector =
...
async function fillData(user, date) {
  ...
  } = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(`/view/data/${user}/${prevMonth}`);
  ...
  Object.entries(textFieldData).forEach((data) => {
    Object.values(data[1]).forEach((field) => {
      (0,_tools_generateUploadInput__WEBPACK_IMPORTED_MODULE_2__.generateUploadInputFields)(data[0].slice(5), field);
    });
  });
}
