...
async function fillData(user, date) {
  ...
  Object.entries(textFieldData).forEach((data) => {
    Object.values(data[1]).forEach((field) => {
      (0,_api_view_api_generateUploadDesc__WEBPACK_IMPORTED_MODULE_2__.generateUploadInputFields)(data[0].slice(5), field);
    });
  });
}
